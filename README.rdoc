...
<i>URL of the GitHub repository: http://github.com/nmb-se/redmine_timetable/tree/master</i>

The source of this plugin can be "cloned" from the GitHub-repo using:

<tt>$ cd {RAILS_ROOT}/plugins && git clone git://github.com/nmb-se/redmine_timetable.git</tt>
